...
class DataCollection extends BatchImport implements DataCollectionContract
{
                                  ...
                                  EmployeeContract $employee,Carbon $fromDate=null,Carbon $toDate=null)
    {
        ...
        $query="
            ...
            INSERT DATA
            {
                <$batchImportUri> a ldog:DataCollection ;
                        rdfs:label '$label' ;
    ...
    public static function retrieve(string $uri): ?self
    {
        ...
        foreach ($resultSet as $result)
        {
            ...
            if($dataTemplateTypeUri==$ldogPrefix.'DataCollectionTemplate')
            {
                $dataTemplate=DataCollectionTemplate::retrieve($result->dataTemplate->getUri());
            }
            ...
            $dataCollection= new self($uri,$result->label->getValue(),$description,
